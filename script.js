document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      var labelEl = contactForm.querySelector('label[for="' + field.id + '"]');
      if (labelEl) {
    ...
    function showFieldError(field, message) {
      ...
      var errorId = (field.id || field.name || Math.random().toString(36).slice(2)) + '-error';
      errorEl.id = errorId;
    ...
    function clearFieldError(field) {
      ...
      var siblingError = field.parentNode.querySelector('.form-error-message');
      if (siblingError) {
        siblingError.parentNode.removeChild(siblingError);
      }
    }

    function showFormSuccess() {
      var existing = contactForm.querySelector('.form-success-message');
  ...
  var animationClass = 'fade-in-visible';
  var animationTriggerClass = 'fade-in-element';
  ...
  var animatableElements = document.querySelectorAll(animatableSelectors.join(', '));

  animatableElements.forEach(function (el) {
    el.classList.add(animationTriggerClass);
  });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אנימה ישראל משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6c79f852-6777-4f73-bd78-9fd75b9ca91b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6c79f852-6777-4f73-bd78-9fd75b9ca91b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6c79f852-6777-4f73-bd78-9fd75b9ca91b';
